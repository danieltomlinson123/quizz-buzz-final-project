              ...
              questionsPublic.map((question) => (
                <li className="list__item" key={question.id}>
                  <div className="question-options-grouped">
                    ...
                    {question.isFav && (
                      <span
                        className="material-symbols-rounded question-option-button-stars--true"
                        onClick={() =>
                    ...
                    {!question.isFav && (
                      <span
                        className="material-symbols-rounded question-option-button-stars--false"
                        onClick={() =>
                          onFavoritesClick(question.id, question.isFav)
                        }
                      >
              ...
              questionsPublic.map((question) => (
                <li className="list__item" key={question.id}>
                  <div className="question-options-grouped">
                    ...
                    {question.isFav && (
                      <span className="material-symbols-rounded question-option-button-stars--true">
                        stars
                      </span>
                    )}
                    {!question.isFav && (
                      <span className="material-symbols-rounded question-option-button-stars--false">
                        stars
                      </span>
                    )}
                    <button
